...
// 物件属性有 .year .month .day .isLeap .yearCyl .dayCyl .monCyl
...
function shengXiao (y = SY) {
  return Animals[(y - 4) % 12]
}

function shengCheng (y = SY, m = SM, d = SD) {
  let sDObj = new Date(y, m, d)
  let lDObj = new Lunar(sDObj)
  return {
    y: cyclical(SY - 1900 + 36),
    m: cyclical(lDObj.monCyl),
    d: cyclical(lDObj.dayCyl),
    day: cDay(lDObj.month, lDObj.day),
    ymd: {
      y: SY,
      m: SM,
      d: SD
...
function festival (y = SY, m = SM, d = SD) {
  let sTermInfo = [
    0, 21208, 42467, 63836, 85337,
    107014, 128867, 150921, 173149,
    195551, 218072, 240693, 263343,
    285989, 308563, 331033, 353350,
    375494, 397447, 419210, 440795,
  ...
  let sFtv = [
    ...
    '0701 建党节 香港回归纪念', '0801 建军节', '0808 父亲节', '0908 茂生日',
    '0909 毛泽东逝世纪念', '0910 教师节', '0928 孔子诞辰', '1001*国庆节',
    '1006 老人节', '1001 ListenWind生日', '1024 联合国日', '1112 孙中山诞辰',
